...
<svelte:head>
	...
	<meta
		name="description"
		content="Mitchell Christ is a frontend developer and CSS nerd, currently residing in Irvine, California."
	/>
...
<main
	class="relative flex flex-col md:mt-[2lh] md:ml-(--toc-width)"
