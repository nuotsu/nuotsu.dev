export const testimonials: {
...
}[] = [
	{
		quote: [
			'This is sick dude.',
			"Love seeing all the <strong>great work</strong> you're doing for <strong>the Sanity Community</strong>."
		],
		author: {
			name: 'Jono',
	...
	{
		quote: [
			'A really cool Sanity + Next.js starter template. Go check it out! 🔥',
			'<strong>Really great work</strong>, Mitchell.'
		],
		author: {
			name: 'Kapehe',
